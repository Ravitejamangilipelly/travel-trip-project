              ...
              >
                <div className="guests-form">
                  ...
                  <div className="adults-container">
                    ...
                    <p className="adults-number" name="adults">
                      {adults}
                    </p>
                  ...
                  <div className="adults-container">
                    ...
                    <p className="adults-number" name="children">
                      {children}
                    </p>
                    <button
                      className="increase"
                  ...
                  <div className="adults-container">
                    ...
                    <p className="adults-number" name="infants">
                      {infants}
                    </p>
                    <button
                      className="increase"
                  ...
                  <div className="guests-container">
                    <Link to="/date-selection">
                      <button type="button" className="guests-previous-button">
                        Previous
                      </button>
                    </Link>
                    <div className="guests-previous">
                      <Link to="/travel-assistance">
                        <button type="button" className="guests-next-button">
                          Next
                        </button>
                      </Link>
                    </div>
